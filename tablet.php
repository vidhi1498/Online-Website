...
<html>
<head>
<style type="text/css" src="hl.css"></style>
...
<br><BR>
    <div class="cover">
      <button class="button"style="font-size:24px" name="ASC" > <i class="fa fa-angle-double-down"></i><a href="tabletlow.php">Low</a> &nsb;</button><br><br>
    </div>
    <div class="cover1">
      <button class="button"style="font-size:24px" name="DESC"> <i class="fa fa-angle-double-up"></i><a href="tablethigh.php">High </a></button>
      </div>-->
  ...
  <div id="content"> 
        ...
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM products where category="electronics" and sub_cat="tablets"');
          if($result === FALSE){
            die(mysql_error());
           }
          echo '<br>';
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              echo '<img class="img-rounded" alt="Cinque Terre" width="170" height="210" src="images/products/'.$obj->product_img_name.'"/>';
