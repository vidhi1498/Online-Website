...
<br><BR>
    <div class="cover">
      <button class="button"style="font-size:24px" name="ASC" > <i class="fa fa-angle-double-down"></i><a href="weslow.php">Low</a> &nsb;</button><br><br>
    </div>
    <div class="cover1">
      <button class="button"style="font-size:24px" name="DESC"> <i class="fa fa-angle-double-up"></i><a href="weshigh.php">High </a></button>
      </div>
  ...
  <div id="content"> 
        ...
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM products where category="women" and sub_cat="western" order by price desc');
          if($result === FALSE){
            die(mysql_error());
           }
          echo '<br>';
