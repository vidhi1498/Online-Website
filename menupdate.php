...
<nav>
 ...
 <li> <input type="text" name="search" placeholder="Search by product code" ></li>
</form></li></i>
<li><a href="orderlist.php">orders</a></li>
 ...
 <li><p top><?php echo '<h3 style="font-family: cursive"> Hey ' .$_SESSION['fname'] .'!!</h3>'; ?></p></li>
         </li>
  </ul>
</nav>
...
<div class="main">
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <h3>Hey Admin!</h3>
        <?php
          $result = $mysqli->query('SELECT * from products where category="men" ');
          if($result) {
