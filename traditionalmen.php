...
<br><BR>
  ...
  <div id="content"> 
        ...
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM products where category="men" and sub_cat="traditional"');
          if($result === FALSE){
            die(mysql_error());
           }
          echo '<br>';
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              echo '<img class="img-rounded" alt="Cinque Terre" width="200" height="230" src="images/products/'.$obj->product_img_name.'"/>';
