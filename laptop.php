...
<!--
  ...
  <div id="content"> 
        ...
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM products where category="electronics" and sub_cat="laptops"');
          if($result === FALSE){
            die(mysql_error());
           }
          echo '<br>';
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              echo '<img class="img-rounded" alt="Cinque Terre" width="300" height="190" src="images/products/'.$obj->product_img_name.'"/>';
